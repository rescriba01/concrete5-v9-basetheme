...
class CustomSkin extends \Concrete\Core\Entity\Page\Theme\CustomSkin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'skinID', 'skinIdentifier', 'pThemeID', 'skinName', 'presetSkinStartingPoint', 'author', 'dateCreated', 'dateUpdated', 'variableCollection', 'customCss'];
        }
    ...
    public function getPresetSkinStartingPoint(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPresetSkinStartingPoint', []);

        return parent::getPresetSkinStartingPoint();
    }
    ...
    public function setPresetSkinStartingPoint(string $presetSkinStartingPoint): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPresetSkinStartingPoint', [$presetSkinStartingPoint]);

        parent::setPresetSkinStartingPoint($presetSkinStartingPoint);
    }
